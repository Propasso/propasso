...
const Kennisbank = () => {
  ...
  const knowledgeBaseDescription =
    "De kennisbank van Propasso met praktische artikelen over exit planning, bedrijfswaarde, verkoopklaarheid en bedrijfsoverdracht voor MKB-ondernemers.";
      ...
      ? [
          {
            "@context": "https://schema.org",
            "@type": "ItemList",
            itemListElement: visiblePosts.map((post: SanityPost, index: number) => ({
              "@type": "ListItem",
              position: index + 1,
  ...
  return (
    <PageLayout>
      <SEO
        title="Kennisbank Exit Planning voor MKB-ondernemers"
        description={knowledgeBaseDescription}
        canonical="https://propasso.nl/kennisbank"
        ogTitle="Kennisbank Exit Planning | Propasso"
        ogDescription="Praktische artikelen over exit planning, bedrijfswaarde, verkoopklaarheid en bedrijfsoverdracht voor MKB-ondernemers."
        ogType="website"
                    ...
                    >
                      <div className="flex items-start justify-between mb-5">
                        ...
                        <span className="text-xs font-semibold text-muted-foreground bg-secondary rounded-full px-3 py-1">
                          {categoryPostCount(cat._id)}{" "}
                          {categoryPostCount(cat._id) === 1 ? "artikel" : "artikelen"}
                        </span>
                      </div>
...
export default Kennisbank;    queryFn: fetchAllCategories,
    staleTime: 1000 * 60 * 10,
  });
