...
const Index = () => {
  return (
    <>
      <Helmet>
        <title>Exit Planning voor het MKB | Bedrijf verkoopklaar maken - Propasso</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="Exit Planning voor het MKB | Bedrijf verkoopklaar maken - Propasso" />
        <meta
