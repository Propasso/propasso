          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <motion.div {...fadeInUp} transition={{ duration: 0.6 }}>
              ...
              <div className="mt-8 space-y-5 text-muted-foreground leading-relaxed">
                ...
                <p>
                  Ik begeleidde het <b>familiebedrijf</b> door een <b>faillissement en doorstart</b>, en{" "}
                  <b>bouwde het uit</b>
                  tot een winstgevende en professionele organisatie. Altijd met veel energie, door het gewoon te doen —
                  met veel vallen en opstaan. Aan de buitenkant was het de groei een succcesverhaal maar dat ging ook
                  gepaard met de nodige stress, twijfel en af en toe ook onzekerheid.
                </p>
                <p>
                  In 2023 besloot ik een nieuw pad in te slaan, ik stelde een directie aan, droeg de dagelijkse leiding
                  over en eind 2024 verkocht ik een groot deel van het bedrijf. Dit brengt mij tot Propasso. Achteraf
